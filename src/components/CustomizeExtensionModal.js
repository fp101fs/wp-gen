...
Generated by plugin.new - Plugin Customization Feature
  ...
  const handleCustomizeAndDownload = async () => {
    ...
    try {
      ...
      if (iconType === 'lucide' && selectedIcon) {
        ...
        // No icon selected, use default plugin.new icon
                        ...
                        {iconType === 'custom' && customIconPreview ? (
                          ...
                          <div className="text-center">
                            <p className="text-white font-medium">
                              {iconType === 'lucide' ? selectedIcon : 'Default plugin.new Icon'}
                            </p>
                          </div>
                        )}
                      </div>
