    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div className="bg-neutral-950 rounded-2xl p-8 max-w-md w-full relative border border-white/10 shadow-2xl">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-[#24292e] text-white py-3 px-4 rounded-lg font-semibold mb-6 flex items-center justify-center space-x-3 hover:bg-[#2f363d] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
